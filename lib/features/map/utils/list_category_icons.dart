...
final List<Icon> categoryIcons = [
  Icon(FontAwesomeIcons.palette, size: iconSize),
  Icon(FontAwesomeIcons.paw, size: iconSize),
  Icon(FontAwesomeIcons.tv, size: iconSize),
  Icon(FontAwesomeIcons.babyCarriage, size: iconSize),
  Icon(FontAwesomeIcons.puzzlePiece, size: iconSize),
